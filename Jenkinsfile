                ...
                failure {
                    try {
                        ...
                        sh 'aws cloudformation delete-stack --region-us-east-1 --stack-name eksctl-test-cluster-name-cluster'                                                                                                
                            ...
                            sh 'echo Failed to delete Cloudformation Stack:' + e.getMessage()
                            sh 'echo Forcing deletion of Cloudformation Stack'
                        ...
                        try {
                            ...
                            sh 'echo Failed to delete EKS Cluster:' + e.getMessage()
                        }
                    }                                                   
                }
            }
